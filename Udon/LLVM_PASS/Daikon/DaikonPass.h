...
class DaikonPass:public ModulePass {
	...
	private:
		...
		void  insertDynamicCallAtGlobalAccess(Function *);
                void insertHookGlobInt( Value* gVal,Instruction* target, BitCastInst* gValNameCast);
		void insertHookInt(Value* val, Instruction* target,  BitCastInst* valNameCast);
		void insertHookPoint(Value* val, Instruction* target,  BitCastInst* valNameCast );
		void insertGlobals(Instruction* target, Module* module);
		void insertArguments(Instruction* target, Module* module, Function* func);
	...
	private:
		...
		Function *hookFunctionBegin;
		Function *hookForInt;
		Function *hookForPoint;
		Function *endOfHookBegin;
                Function *hookFunctionEnd;
		Function *endOfHookEnd;
